...
\backgroundsetup{
  contents = {\includegraphics[width=\paperwidth]{Resources/Guten Tag.jpeg}},%
  scale = 1,%
  color = black,%
  placement = top,%
  opacity = 1,%
...
\newfontfamily{\symbolfont}{GutenTagSymbols.ttf}
\newfontfamily{\arfont}{LyonArabicText-Regular.otf}[%
  Path = {Resources/},%
  Script = Arabic]
...
\setmonofont{Codelia}
\newfontfamily{\mediummonofont}{Codelia Medium}
...
% Syntax Highlighting
\newcommand*{\Keyword}[1]{\textcolor{black!70}{\mediummonofont#1}}
\newcommand*{\Operator}[1]{\emph{#1}}
\newcommand*{\ControlFlow}[1]{\textcolor{blue!65!green!85!black}{\mediumitalicmonofont#1}}
\newcommand*{\Storage}[1]{\textcolor{blue!65!green!85!black}{#1}}
\newcommand*{\Number}[1]{\textcolor{blue!65!green!85!black}{#1}}
\newcommand*{\String}[1]{\textcolor{red!80!black}{#1}}
\newcommand*{\Class}[1]{\textcolor{green!45!black}{#1}}
\newcommand*{\Variable}[1]{\textcolor{blue!50!green!50!black!75}{#1}}
...
% [frame][scale]{file}
\NewDocumentCommand{\Screenshot}{s O{0, 0, 0, 0} O{1.5} m}{%
  \ScreenshotGraphic%
    {#4}%
...
\begin{document}
  \begin{titlepage}
    \includepdf[pages=1]{Resources/Cover.pdf}
  \end{titlepage}
