...
Click \Label{Record shortcut} next to a command name and press a combination of modifier keys~-- Command~(\KeyboardEquivalent{command}), Option~(\KeyboardEquivalent{option}), Control~(\KeyboardEquivalent{control}), and Shift~(\KeyboardEquivalent{shift})~-- and a normal (non-modifier) key.
